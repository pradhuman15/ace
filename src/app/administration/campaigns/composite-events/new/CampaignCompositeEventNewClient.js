...
export default function CampaignCompositeEventNewClient({ advertiserList }) {
    ...
    const [selectedFloodlights, setSelectedFloodlights] = React.useState([]);
    ...
    return (
        <Stack gap={1}>
            ...
            <Box sx={{
                ...
                <IconButton onClick={redirectToListPage}>
                    <ArrowBackIcon />
                </IconButton>
